...
const MARKINGS = [
  ...
  { code: 'RM12', name: 'No stopping line', cite: '§7.2.16', verdict: 'redraw',
    note: 'The fabricated "broken red / selective periods" panel has been removed by the cleaner. The chart confirms a single continuous solid red line, 24 hours — there is no broken variant.' },
  { code: 'RM13', name: 'No parking line', cite: '§7.2.17', verdict: 'redraw',
    note: 'Same as RM12 — fabricated broken-yellow panel removed. Chart confirms one continuous solid yellow line, 24 hours.' },
