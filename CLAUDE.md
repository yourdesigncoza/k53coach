...
| `exam_attempts` | 5 — **all fixtures**, every one the e2e buyer's (`129a84e0`), created by `scripts/e2e/assessment.mjs` on 2026-08-05. No real learner has sat a mock. Don't read these as usage |
